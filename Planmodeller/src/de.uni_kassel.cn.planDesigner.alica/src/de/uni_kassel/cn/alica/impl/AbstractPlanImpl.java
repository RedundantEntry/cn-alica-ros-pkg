 ...
 * <ul>
 *   <li>{@link de.uni_kassel.cn.alica.impl.AbstractPlanImpl#getRating <em>Rating</em>}</li>
 *   <li>{@link de.uni_kassel.cn.alica.impl.AbstractPlanImpl#getConditions <em>Conditions</em>}</li>
 *   <li>{@link de.uni_kassel.cn.alica.impl.AbstractPlanImpl#isMasterPlan <em>Master Plan</em>}</li>
 *   <li>{@link de.uni_kassel.cn.alica.impl.AbstractPlanImpl#getUtilityFunction <em>Utility Function</em>}</li>
 *   <li>{@link de.uni_kassel.cn.alica.impl.AbstractPlanImpl#getUtilities <em>Utilities</em>}</li>
 *   <li>{@link de.uni_kassel.cn.alica.impl.AbstractPlanImpl#getUtilityThreshold <em>Utility Threshold</em>}</li>
 *   <li>{@link de.uni_kassel.cn.alica.impl.AbstractPlanImpl#getVars <em>Vars</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AbstractPlanImpl extends PlanElementImpl implements AbstractPlan {
	 ...
	 * @ordered
	 */
	protected EList<UtilityReference> utilities;
	 ...
	 * @ordered
	 */
	protected static final double UTILITY_THRESHOLD_EDEFAULT = 1.0;
	 ...
	 * @generated
	 */
	public EList<UtilityReference> getUtilities() {
		if (utilities == null) {
			utilities = new EObjectContainmentEList<UtilityReference>(UtilityReference.class, this, AlicaPackage.ABSTRACT_PLAN__UTILITIES);
		}
		return utilities;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case AlicaPackage.ABSTRACT_PLAN__UTILITIES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case AlicaPackage.ABSTRACT_PLAN__UTILITIES:
				getUtilities().clear();
				getUtilities().addAll((Collection<? extends UtilityReference>)newValue);
				return;
			case AlicaPackage.ABSTRACT_PLAN__UTILITY_THRESHOLD:
