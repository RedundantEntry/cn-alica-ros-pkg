 ...
 * <ul>
 *   <li>{@link de.uni_kassel.cn.alica.impl.EntryPointImpl#getTask <em>Task</em>}</li>
 *   <li>{@link de.uni_kassel.cn.alica.impl.EntryPointImpl#isSuccessRequired <em>Success Required</em>}</li>
 *   <li>{@link de.uni_kassel.cn.alica.impl.EntryPointImpl#getState <em>State</em>}</li>
 *   <li>{@link de.uni_kassel.cn.alica.impl.EntryPointImpl#getMinCardinality <em>Min Cardinality</em>}</li>
 *   <li>{@link de.uni_kassel.cn.alica.impl.EntryPointImpl#getMaxCardinality <em>Max Cardinality</em>}</li>
 *   <li>{@link de.uni_kassel.cn.alica.impl.EntryPointImpl#getPlan <em>Plan</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EntryPointImpl extends PlanElementImpl implements EntryPoint {
	 ...
	 * @ordered
	 */
	protected static final boolean SUCCESS_REQUIRED_EDEFAULT = true;
	/**
