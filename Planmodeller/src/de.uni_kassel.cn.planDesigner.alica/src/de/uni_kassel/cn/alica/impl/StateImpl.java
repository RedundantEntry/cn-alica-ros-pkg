 ...
 * <ul>
 *   <li>{@link de.uni_kassel.cn.alica.impl.StateImpl#getPlans <em>Plans</em>}</li>
 *   <li>{@link de.uni_kassel.cn.alica.impl.StateImpl#getInPlan <em>In Plan</em>}</li>
 *   <li>{@link de.uni_kassel.cn.alica.impl.StateImpl#getParametrisation <em>Parametrisation</em>}</li>
 *   <li>{@link de.uni_kassel.cn.alica.impl.StateImpl#getInTransitions <em>In Transitions</em>}</li>
 *   <li>{@link de.uni_kassel.cn.alica.impl.StateImpl#getOutTransitions <em>Out Transitions</em>}</li>
 *   <li>{@link de.uni_kassel.cn.alica.impl.StateImpl#getEntryPoint <em>Entry Point</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateImpl extends PlanElementImpl implements State {
	...
	/**
	 * <!-- begin-user-doc -->
	 * Ensures all parametrisations are valid by removing all invalid ones
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
