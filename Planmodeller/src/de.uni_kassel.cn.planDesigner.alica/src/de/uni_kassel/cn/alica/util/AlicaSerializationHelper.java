...
//		meta.setFeatureKind(AlicaPackage.eINSTANCE.getTask_EntryPoint(), ExtendedMetaData.ELEMENT_FEATURE);
	}
	...
	*/
	private void createTerminalStateSaveOptions(ExtendedMetaData meta){
		meta.setFeatureKind(AlicaPackage.eINSTANCE.getTerminalState_Result(), ExtendedMetaData.ELEMENT_FEATURE);		
	}
