...
package de.uni_kassel.cn.planDesigner.ui.editors;
...
import de.uni_kassel.cn.alica.provider.AlicaItemProviderAdapterFactory;
import de.uni_kassel.cn.alica.util.AlicaSerializationHelper;
import de.uni_kassel.cn.planDesigner.ui.PlanDesignerActivator;
import de.uni_kassel.cn.planDesigner.ui.PlanEditorEditPartFactory;
import de.uni_kassel.cn.planDesigner.ui.adapter.HiddenElementProviderFactory;
import de.uni_kassel.cn.planDesigner.ui.adapter.PlanEditorHiddenElementProviderFactory;
import de.uni_kassel.cn.planDesigner.ui.commands.CalculatePlanCardinalitiesCommand;
import de.uni_kassel.cn.planDesigner.ui.commands.CreateUIExtensionCommmand;
import de.uni_kassel.cn.planDesigner.ui.commands.EMF2GEFCommandStack;
import de.uni_kassel.cn.planDesigner.ui.commands.EnsurePlanParametrisationConsistencyCommand;
import de.uni_kassel.cn.planDesigner.ui.edit.PMLTransactionalEditingDomain;
import de.uni_kassel.cn.planDesigner.ui.properties.ICommandStackTabbedPropertySheetPageContributor;
...
import de.uni_kassel.cn.planDesigner.ui.uiextensionmodel.provider.PmlUIExtensionModelItemProviderAdapterFactory;
import de.uni_kassel.cn.planDesigner.ui.util.CommonUtils;
import de.uni_kassel.cn.planDesigner.ui.util.DiagramDropTargetListener;
import de.uni_kassel.cn.planDesigner.ui.util.IEditorConstants;
import de.uni_kassel.cn.planDesigner.ui.util.OverviewOutlinePage;
import de.uni_kassel.cn.planDesigner.ui.util.PlanEditorUtils;
import de.uni_kassel.cn.planDesigner.ui.util.PlanMapper;
import de.uni_kassel.cn.planDesigner.ui.util.PlanmodellerEditorPaletteFactory;
import de.uni_kassel.cn.planDesigner.ui.util.UIAwareEditor;
...
//				if (PlanEditorUtils.isModifiedResourceAffected(PlanEditor.this, affectedResources)) {
	...
	public PlanEditor() {
		...
		undoContext = new ObjectUndoContext(this, IEditorConstants.PLAN_EDITOR_ID);
	}
...
//		getEditingDomain().removeResourceSetListener(getResourceSetListener());
	...
	private GraphicalViewer createGraphicalViewer(Composite parent) {
		...
		allowedIds.add("de.uni_kassel.cn");
...
//	}
	...
	protected FlyoutPreferences getPalettePreferences() {
		return FlyoutPaletteComposite
				.createFlyoutPreferences(PlanDesignerActivator.getDefault().getPluginPreferences());
	}
...
//		getSite().getWorkbenchWindow().getPartService().addPartListener(partListener);
	...
	public String getContributorId() {
		return IEditorConstants.PLAN_EDITOR_ID;
	}
...
//		return uiExtensionMap;
	...
	public PmlUiExtension getUIExtension(final EObject obj, boolean create) {
		...
		PmlUiExtension ext = map.getExtensions().get(obj);
	...
	private void removeCorruptExtensions() throws RollbackException, InterruptedException{
		getEMFCommandStack().execute(new RecordingCommand(getEditingDomain()){
			...
			protected void doExecute() {
				...
				Set<EObject> keys = myUIMap.getExtensions().keySet();
				...
				for(EObject e : toRemove)
					myUIMap.getExtensions().remove(e);
			}
