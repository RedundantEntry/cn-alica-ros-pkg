...
import de.uni_kassel.cn.planDesigner.ui.RolesetEditPartFactory;
import de.uni_kassel.cn.planDesigner.ui.actions.AutoLayoutAction;
import de.uni_kassel.cn.planDesigner.ui.actions.ExpandCollapseAllAction;
import de.uni_kassel.cn.planDesigner.ui.actions.RolesetDiagramContextMenuProvider;
...
import de.uni_kassel.cn.planDesigner.ui.exception.PlanNotFoundException;
...
import de.uni_kassel.cn.planDesigner.ui.util.GraphDelta;
...
import de.uni_kassel.cn.planDesigner.ui.util.TaskGraphBuilder;
import de.uni_kassel.cn.planDesigner.ui.util.ToolbarComposite;
...
public class RolesetEditor extends EditorPart implements ICommandStackTabbedPropertySheetPageContributor,IEditingDomainProvider, ISelectionProvider, IAdaptable, UIAwareEditor{
	...
	public RolesetEditor() {
		super();
		createActions();
		undoContext = new ObjectUndoContext(this, IEditorConstants.ROLESET_EDITOR_ID);
	}
...
//		g.setFocus();
	...
	private GraphicalViewer createGraphicalViewer(Composite parent) {
		...
		getSite().registerContextMenu(IEditorConstants.ROLESET_EDITOR_ID, 
...
//			this.editDomain.setPaletteRoot(getPaletteRoot());
	...
	private Resource getRolesetResource() {
	...
	private Plan getMasterPlan() {
		return masterPlan;
	}

	private void setMasterPlan(Plan masterPlan) {
	...
	private void setGraph(TaskGraph graph) {
		this.graph = graph;
	}
