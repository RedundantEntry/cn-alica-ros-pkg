...
public abstract class CollapsableFigure extends Figure implements HandleBounds{
	...
	public void setCollapsed(boolean collapsed) {
		...
		getArrowLabel().setIcon(this.collapsed ? reg.get(
				IEditorConstants.ICON_ARROW_RIGHT_10) : reg.get(IEditorConstants.ICON_ARROW_DOWN_10));
	}
	...
	public void hideCollapseControls(){
		...
		// Set the correct icon
		getArrowLabel().setIcon(reg.get(IEditorConstants.ICON_ARROW_RIGHT_DISABLE_10));
	}
	...
	public void unhideCollapsControls(){
		...
		// Set the correct icon
		getArrowLabel().setIcon(reg.get(IEditorConstants.ICON_ARROW_RIGHT_10));
