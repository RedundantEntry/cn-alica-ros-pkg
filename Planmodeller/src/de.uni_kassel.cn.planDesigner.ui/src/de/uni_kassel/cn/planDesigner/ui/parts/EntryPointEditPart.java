...
import de.uni_kassel.cn.planDesigner.ui.adapter.PlanElementExclusionAdapter;
...
import de.uni_kassel.cn.planDesigner.ui.policies.DragDropEditPolicy;
import de.uni_kassel.cn.planDesigner.ui.policies.EntryPointLayoutEditPolicy;
...
public class EntryPointEditPart extends PlanElementEditPart {
	...
	public IFigure getMainFigure() {
		if (pointFigure == null) {
			pointFigure = new ImageFigure(PlanDesignerActivator.getDefault().getImageRegistry().get(IEditorConstants.ICON_ENTRY_POINT_15));
		}
		return pointFigure;
	}
...
//		
	...
	protected void createEditPolicies() {
		...
		installEditPolicy("DragDropRole", new DragDropEditPolicy());
	}
