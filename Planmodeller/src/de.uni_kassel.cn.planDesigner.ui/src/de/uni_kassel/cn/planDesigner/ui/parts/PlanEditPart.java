...
import de.uni_kassel.cn.planDesigner.ui.figures.HiddenElementsInfoFigure;
import de.uni_kassel.cn.planDesigner.ui.figures.PlanFigure;
import de.uni_kassel.cn.planDesigner.ui.layout.InfoLocator;
import de.uni_kassel.cn.planDesigner.ui.layout.PMLXYLayout;
import de.uni_kassel.cn.planDesigner.ui.policies.PlanXYLayoutEditPolicy;
...
public class PlanEditPart extends AbstractPlanEditPart {
	...
	protected IFigure findFigure(EditPart part) {
		...
		else if (part.getModel() instanceof Result)
	...
	protected void refreshVisuals() {
		...
		{
			getPlanFigure().getNameHolder().setBackgroundColor(PlanDesignerActivator.getDefault().getColorRegistry().get(IEditorConstants.MASTER_PLAN_LABEL_BACKGROUND_COLOR));
		} else {
			getPlanFigure().getNameHolder().setBackgroundColor(PlanDesignerActivator.getDefault().getColorRegistry().get(IEditorConstants.PLAN_LABEL_BACKGROUND_COLOR));
		}
