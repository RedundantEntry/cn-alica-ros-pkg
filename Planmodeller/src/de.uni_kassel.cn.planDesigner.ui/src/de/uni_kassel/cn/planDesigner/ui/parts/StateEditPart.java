...
import de.uni_kassel.cn.planDesigner.ui.figures.CollapsableFigure;
...
import de.uni_kassel.cn.planDesigner.ui.policies.PMLFlowLayoutEditPolicy;
...
public class StateEditPart extends CollapsableEditPart{
	...
	protected IFigure createDescriptionFigure() {
		...
		this.mainFigure = new ImageFigure(plugin.getImageRegistry().get(IEditorConstants.ICON_STATE_50));
