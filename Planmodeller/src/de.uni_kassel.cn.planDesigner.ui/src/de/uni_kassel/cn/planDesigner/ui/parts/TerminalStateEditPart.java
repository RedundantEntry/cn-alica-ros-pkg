...
public class TerminalStateEditPart extends StateEditPart {
	...
	protected List getModelChildren() {
		...
		if(getTerminalState().getResult() != null)
			result.add(getTerminalState().getResult());
	...
	protected List<PlanElement> getExpandedChildren() {
		...
		Result r = getTerminalState().getResult();
		if(r!=null) {
			children.add(r);
		}
		return children;
...
//		installEditPolicy(StateEditPart.DRAG_DROP_ROLE, null);
		super.createEditPolicies();
		//removeEditPolicy(StateEditPart.DRAG_DROP_ROLE);
	}
}
