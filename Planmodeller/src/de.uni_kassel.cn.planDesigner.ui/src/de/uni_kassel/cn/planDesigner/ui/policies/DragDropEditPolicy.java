...
import de.uni_kassel.cn.planDesigner.ui.wizards.PMLNewBehaviourConfigurationWizard;
...
public class DragDropEditPolicy extends GraphicalEditPolicy {
	...
	public Command getCommand(Request request) {
		...
		if(request.getType().equals(RequestConstants.REQ_DRAG))
			...
			if(dialog.open() == Dialog.OK){
				...
				if(config != null){
					...
					compound.append(CreateChildCommand.create(
							editingDomain,
							behaviour, 
							new CommandParameter(null,null,config), 
