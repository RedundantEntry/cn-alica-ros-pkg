...
import de.uni_kassel.cn.planDesigner.ui.commands.SetNameAndDirectEditCommand;
	...
	protected Command getCreateCommand(CreateRequest req) {
		...
		if(hostEditPart.getModel() instanceof EObject){
			...
			//if(exclusionSet == null || (exclusionSet != null && !exclusionSet.contains(newChild.eClass()))){
				...
				compound.append(CreateChildCommand.create(editingDomain, parent, new CommandParameter(null, null, newChild), Collections.emptyList()));
