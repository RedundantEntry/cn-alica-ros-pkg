...
import de.uni_kassel.cn.planDesigner.ui.util.ContainerDialog;
...
public class PlanDesignerPreferencePage extends PreferencePage implements
	...
	private void initializeValues() {
		...
		textFieldmap.get(ROLE_DEF_TEXT).setText(store.getString(IEditorConstants.PREF_ROLE_DEFINITION_CONTAINER));
		textFieldmap.get(CAP_DEF_TEXT).setText(store.getString(IEditorConstants.PREF_CAPABILITY_DEFINITION_CONTAINER));
		textFieldmap.get(CODEGEN_BASE_TEXT).setText(store.getString(IEditorConstants.PREF_CODEGEN_BASE_PATH));
		textFieldmap.get(MISCELLANEOUS_TEXT).setText(store.getString(IEditorConstants.PREF_MISC_PATH));
	}
	
	private void initializeDefaults(){
		IPreferenceStore store = getPreferenceStore();
		textFieldmap.get(ROLE_DEF_TEXT).setText(store.getDefaultString(IEditorConstants.PREF_ROLE_DEFINITION_CONTAINER));
		textFieldmap.get(CAP_DEF_TEXT).setText(store.getDefaultString(IEditorConstants.PREF_CAPABILITY_DEFINITION_CONTAINER));
		textFieldmap.get(CODEGEN_BASE_TEXT).setText(store.getDefaultString(IEditorConstants.PREF_CODEGEN_BASE_PATH));
		textFieldmap.get(MISCELLANEOUS_TEXT).setText(store.getDefaultString(IEditorConstants.PREF_MISC_PATH));
	}
	...
	private void storeValues(){
		...
		store.setValue(IEditorConstants.PREF_ROLE_DEFINITION_CONTAINER, textFieldmap.get(ROLE_DEF_TEXT).getText());
		store.setValue(IEditorConstants.PREF_CAPABILITY_DEFINITION_CONTAINER, textFieldmap.get(CAP_DEF_TEXT).getText());
		store.setValue(IEditorConstants.PREF_CODEGEN_BASE_PATH, textFieldmap.get(CODEGEN_BASE_TEXT).getText());
		store.setValue(IEditorConstants.PREF_MISC_PATH, textFieldmap.get(MISCELLANEOUS_TEXT).getText());
	}
