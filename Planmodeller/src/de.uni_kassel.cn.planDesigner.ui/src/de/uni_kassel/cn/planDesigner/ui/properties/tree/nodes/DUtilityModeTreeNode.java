...
public class DUtilityModeTreeNode extends AbstractEMFTreeNode
{
	...
	{
		return ((UtilityMode)getModelObject()).getMode().getLiteral();
	}

	@Override
	protected void createChildren(List<ITreeNode> children)
	{
		UtilityMode m = (UtilityMode)getModelObject();
	...
	public void setValue(Object value)
	{
		if(value instanceof Integer)
		{
			...
			Command uc = SetCommand.create(getEditingDomain(), getModelObject(), AlicaPackage.eINSTANCE.getUtilityMode_Mode(), mode);
