...
public class ZoomTool extends AbstractTool {
	...
	protected Cursor createCursor() {
		...
		ImageData source = PlanDesignerActivator.getDefault().getImageRegistry().get(IEditorConstants.ICON_CURSOR_ZOOM_IN_OUT).getImageData();
		ImageData mask = PlanDesignerActivator.getDefault().getImageRegistry().get(IEditorConstants.ICON_CURSOR_ZOOM_MASK).getImageData();
