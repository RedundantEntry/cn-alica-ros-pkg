...
public class CapabilityDefinitionDialog extends Dialog {
	...
	private class CapabilityLabelProvider implements ILabelProvider{
		...
		public Image getImage(Object element) {
			if(element instanceof Capability)
				return PlanDesignerActivator.getDefault().getImageRegistry().get(IEditorConstants.ICON_CAPABILITY_16);
	...
	private void initializeHeader(Composite parent){
		...
		imgLabel.setImage(PlanDesignerActivator.getDefault().getImageRegistry().get(IEditorConstants.ICON_ROLE_DEFINITION_64));
			...
			public void widgetSelected(SelectionEvent e) {
				...
				domain.getCommandStack().execute(
						CreateChildCommand.create(
								domain, 
								input, 
								new CommandParameter(null,null,r), 
			...
			public void widgetSelected(SelectionEvent e) {
				...
				domain.getCommandStack().execute(
						CreateChildCommand.create(
								...
								new CommandParameter(null,null,c), 
								Collections.emptyList()));
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setImage(PlanDesignerActivator.getDefault().getImageRegistry().get(IEditorConstants.ICON_CAPABILITY_DEFINITION_16));
	}
	...
	private Group createCapabilityDataGroup(Composite parent) {
		...
		capNameText.addListener(SWT.FocusOut, getEditController());
	...
	private Group createCapValueDataGroup(Composite parent) {
		...
		capValueText.addListener(SWT.FocusOut, getEditController());
