...
import de.uni_kassel.cn.planDesigner.ui.adapter.ContentChangeListener;
import de.uni_kassel.cn.planDesigner.ui.adapter.HiddenElementProviderFactory;
import de.uni_kassel.cn.planDesigner.ui.commands.ExecuteAndRefreshPlanCommand;
import de.uni_kassel.cn.planDesigner.ui.commands.HideElementCommand;
	...
	private void configureToolbar()
	{
		...
		tbm.add(new Action("Show overview", 
				ImageDescriptor.createFromImage(
						PlanDesignerActivator.getDefault().getImageRegistry().get(IEditorConstants.ICON_OVERVIEW_16)))
		{
			@Override
			public void run()
			{
		...
		ImageDescriptor.createFromImage(
				PlanDesignerActivator.getDefault().getImageRegistry().get(IEditorConstants.ICON_HIDDEN_16)))
		{
			@Override
			public void run()
			{
