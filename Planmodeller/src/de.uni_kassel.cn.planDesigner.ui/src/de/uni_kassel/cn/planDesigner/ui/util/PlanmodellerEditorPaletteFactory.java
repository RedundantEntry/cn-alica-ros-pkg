...
import de.uni_kassel.cn.planDesigner.ui.tool.BehaviourCreationToolEntry;
import de.uni_kassel.cn.planDesigner.ui.tool.PlanCreationToolEntry;
import de.uni_kassel.cn.planDesigner.ui.tool.PlanningProblemCreationTool;
import de.uni_kassel.cn.planDesigner.ui.tool.PlanningProblemCreationToolEntry;
import de.uni_kassel.cn.planDesigner.ui.tool.PlantypeCreationToolEntry;
import de.uni_kassel.cn.planDesigner.ui.tool.ZoomToolEntry;
...
public final class PlanmodellerEditorPaletteFactory {
	...
	private static PaletteContainer createBasicDrawer() {
		...
		CombinedTemplateCreationEntry component = new PlanCreationToolEntry("Plan", "Create a plan",
				new ModelCreationFactory(AlicaPackage.eINSTANCE.getPlan()), PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_PLAN_16), PLUGIN
						.getImageRegistry().getDescriptor(IEditorConstants.ICON_PLAN_24));
		...
		component = new PlantypeCreationToolEntry("Plantype", "Create a plantype", new ModelCreationFactory(AlicaPackage.eINSTANCE.getPlanType()), PLUGIN
				.getImageRegistry().getDescriptor(IEditorConstants.ICON_PLANTYPE_16), PLUGIN.getImageRegistry()
				.getDescriptor(IEditorConstants.ICON_PLANTYPE_24));
		componentsDrawer.add(component);

		component = new PlanningProblemCreationToolEntry("PlanningProblem", "Create a planningproblem", new ModelCreationFactory(
				AlicaPackage.eINSTANCE.getPlanningProblem()), PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_PLANNING_PROBLEM_16), PLUGIN
				.getImageRegistry().getDescriptor(IEditorConstants.ICON_PLANNING_PROBLEM_24));
		componentsDrawer.add(component);
		...
		component = new CombinedTemplateCreationEntry("State", "Create a state", new ModelCreationFactory(AlicaPackage.eINSTANCE.getState()), PLUGIN
				.getImageRegistry().getDescriptor(IEditorConstants.ICON_STATE_16), PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_STATE_24));
		componentsDrawer.add(component);
		...
		component = new BehaviourCreationToolEntry("Behaviour", "Create a behaviour", new ModelCreationFactory(AlicaPackage.eINSTANCE.getBehaviour()), PLUGIN
				.getImageRegistry().getDescriptor(IEditorConstants.ICON_BEHAVIOUR_16), PLUGIN.getImageRegistry().getDescriptor(
				IEditorConstants.ICON_BEHAVIOUR_24));
		componentsDrawer.add(component);
		...
		component = new CombinedTemplateCreationEntry("Task", "Create a task", new ModelCreationFactory(AlicaPackage.eINSTANCE.getTask()), PLUGIN
				.getImageRegistry().getDescriptor(IEditorConstants.ICON_TASK_16), PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_TASK_24));
		componentsDrawer.add(component);
		
		component = new CombinedTemplateCreationEntry("Entry point", "Create an entry point", new ModelCreationFactory(
				AlicaPackage.eINSTANCE.getEntryPoint()), PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_ENTRY_POINT_16), PLUGIN
				.getImageRegistry().getDescriptor(IEditorConstants.ICON_ENTRY_POINT_24));
		componentsDrawer.add(component);

		component = new CombinedTemplateCreationEntry("Success State", "Create a success state", new ModelCreationFactory(
				AlicaPackage.eINSTANCE.getSuccessState()), PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_SUCCESS_POINT_16), PLUGIN
				.getImageRegistry().getDescriptor(IEditorConstants.ICON_SUCCESS_POINT_24));
		componentsDrawer.add(component);

		component = new CombinedTemplateCreationEntry("Failure State", "Create a failure state", new ModelCreationFactory(
				AlicaPackage.eINSTANCE.getFailureState()), PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_FAILURE_POINT_16), PLUGIN
				.getImageRegistry().getDescriptor(IEditorConstants.ICON_FAILURE_POINT_24));
		componentsDrawer.add(component);
		
		component = new CombinedTemplateCreationEntry("Synchronisation", "Create an Synchronisation", new ModelCreationFactory(
				AlicaPackage.eINSTANCE.getSynchronisation()), PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_SYNCHRONISATION_16), PLUGIN
				.getImageRegistry().getDescriptor(IEditorConstants.ICON_SYNCHRONISATION_24));
		componentsDrawer.add(component);
	...
	private static PaletteContainer createConditionsDrawer() {
		...
		CombinedTemplateCreationEntry component = new CombinedTemplateCreationEntry("Precondition", "Create a precondition", new ModelCreationFactory(
				AlicaPackage.eINSTANCE.getPreCondition()), PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_PRE_CONDITION_16), PLUGIN
				.getImageRegistry().getDescriptor(IEditorConstants.ICON_PRE_CONDITION_24));
		componentsDrawer.add(component);

		component = new CombinedTemplateCreationEntry("Runtime condition", "Create a runtime condition", new ModelCreationFactory(
				AlicaPackage.eINSTANCE.getRuntimeCondition()), PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_RUNTIME_CONDITION_16), PLUGIN
				.getImageRegistry().getDescriptor(IEditorConstants.ICON_RUNTIME_CONDITION_24));
		componentsDrawer.add(component);

		component = new CombinedTemplateCreationEntry("Result", "Create a result", new ModelCreationFactory(AlicaPackage.eINSTANCE.getResult()), PLUGIN
				.getImageRegistry().getDescriptor(IEditorConstants.ICON_RESULT_16), PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_RESULT_24));
		componentsDrawer.add(component);
	...
	private static PaletteContainer createTransitionsDrawer() {
		...
		CreationToolEntry component = new ConnectionCreationToolEntry("Transition", "Create a transition", 
				...
				PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_TRANSITION_16), 
				PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_TRANSITION_24));
		componentsDrawer.add(component);
		...
		component = new ConnectionCreationToolEntry("Sync Transition", "Sync a transition", 
				...
				PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_SYNC_TRANSITION_16), 
				PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_SYNC_TRANSITION_24));
		componentsDrawer.add(component); 
		...
		component = new ConnectionCreationToolEntry("Init State", "Choose initial state for an entry point", 
				...
				PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_INITIAL_STATE_CONNECTION_16), 
				PLUGIN.getImageRegistry().getDescriptor(IEditorConstants.ICON_INITIAL_STATE_CONNECTION_24));
		componentsDrawer.add(component);
