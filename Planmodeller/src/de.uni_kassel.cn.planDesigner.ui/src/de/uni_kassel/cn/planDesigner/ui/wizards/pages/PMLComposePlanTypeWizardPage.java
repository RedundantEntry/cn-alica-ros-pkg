	...
	private class AnnotatedPlanListLabelProvider extends LabelProvider implements ITableLabelProvider{
		...
		public Image getColumnImage(Object element, int columnIndex)
        {
        	if (columnIndex == 0)
        	{
        		...
        		if (temp.isActivated())
        			return PlanDesignerActivator.getDefault().getImageRegistry().get(IEditorConstants.ICON_SUCCESS_POINT_15);
        			
        		else
        			return PlanDesignerActivator.getDefault().getImageRegistry().get(IEditorConstants.ICON_FAILURE_TRANSITION_16);
        	}
        	else return null;
        }
	}
	...
	public void createControl(Composite parent) {
		...
		plantypeTableViewer.setCellEditors
	    	(
				new CellEditor[]
				{
					new CheckboxCellEditor(table), null
				}
	    	);   
