...
{
	public static final String	ROLES_LOCATION					= "/etc/roles";

	public static final String	MISC_LOCATION					= "/etc/Misc";

	public static final String	PLANS_LOCATION					= "/etc/plans";

	public static final String	EXPRESSION_VALIDATORS_LOCATION	= "/src/Expr";//"/src/Base/BehaviourEngine/ExpressionValidators";//"/AlicaBase/src/Expressions";
	...
	public StartupConfigurationProjectsPage()
	{
		...
		// init paths
		// doesn't get ES_ROOT!??!?!
		// rootPath = System.getenv("ES_ROOT");
		rootPath = System.getenv("HOME") + File.separator + "cn";
		if (rootPath == null)
		{
			rootPath = "";
		}
		...
		miscProject = store.getString(IEditorConstants.PREF_MISC_PATH);
		rolesProject = store.getString(IEditorConstants.PREF_ROLE_DEFINITION_CONTAINER);
		exprValProject = store.getString(IEditorConstants.PREF_CODEGEN_BASE_PATH);
...
//		top.setLayoutData(new GridData(GridData.FILL_BOTH));
	...
	{
		/*
		File fe = new File(rootPath + EXPRESSION_VALIDATORS_LOCATION);
		File fp = new File(rootPath + PLANS_LOCATION);
		File fr = new File(rootPath + ROLES_LOCATION);
		File fm = new File(rootPath + MISC_LOCATION);
		*/
		...
		if (!dirsThere)
		{
			setErrorMessage("The root directory seems incorrect, at least one project directory couldn't be found!");
		}
		else
		{
